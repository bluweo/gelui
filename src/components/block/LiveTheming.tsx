  ...
  return (
    <div style={{ borderRadius: "var(--glass-radius-sm, 10px)", overflow: "hidden", background: tableBg, border: `1px solid ${borderColor}`, height: "100%" }}>
      <div style={{ padding: "10px 12px", background: headerBg, borderBottom: `1px solid ${borderColor}` }}>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.06em", fontFamily: "var(--font-ui)", color: headerText }}>How It Works</span>
      </div>
      {chains.map((ch, idx) => {
        ...
        return (
          <div key={ch.variable} style={{ display: "flex", alignItems: "center", padding: "10px 12px", borderBottom: idx < chains.length - 1 ? `1px solid ${rowBorder}` : "none", gap: "8px" }}>
            <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-body)", color: labelText, minWidth: 90, flexShrink: 0 }}>{ch.setting}</span>
            <Arrow isDark={isDark} />
  ...
  return (
    <div style={{ borderRadius: "var(--glass-radius-sm, 10px)", overflow: "hidden", background: tableBg, border: `1px solid ${borderColor}`, height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "10px 12px", background: headerBg, borderBottom: `1px solid ${borderColor}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.06em", fontFamily: "var(--font-ui)", color: headerText }}>Appearance</span>
      ...
      <div style={{ padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
          <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.04em", fontFamily: "var(--font-ui)", color: labelText }}>Transparency</span>
      ...
      {/* Border Radius */}
      <div style={{ padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.04em", fontFamily: "var(--font-ui)", color: labelText, display: "block", marginBottom: 8 }}>Border Radius</span>
      ...
      <div style={{ padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
          <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.04em", fontFamily: "var(--font-ui)", color: labelText }}>Blur Intensity</span>
      ...
      <div style={{ padding: "10px 12px" }}>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.04em", fontFamily: "var(--font-ui)", color: labelText, display: "block", marginBottom: 8 }}>Shadow Depth</span>
        <div style={{ display: "flex", gap: 2, padding: 3, borderRadius: "var(--glass-radius-pill, 100px)", background: segBg }}>
          {shadowOptions.map(o => (
...
function LivePreview({ isDark }: { isDark: boolean }) {
  ...
  return (
    <div style={{ borderRadius: "var(--glass-radius-sm, 10px)", overflow: "hidden", background: tableBg, border: `1px solid ${borderColor}`, height: "100%" }}>
      <div style={{ padding: "10px 12px", background: headerBg, borderBottom: `1px solid ${borderColor}` }}>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.06em", fontFamily: "var(--font-ui)", color: headerText }}>Live Preview</span>
      </div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-body)", color: labelText }}>Gel Button</span>
        <Button variant="gel" size="sm">Button</Button>
      </div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-body)", color: labelText }}>Glass Card</span>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderBottom: `1px solid ${rowBorder}`, gap: 10 }}>
        <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-body)", color: labelText, flexShrink: 0 }}>Input</span>
        <Input placeholder="Type here..." style={{ maxWidth: 140, fontSize: 12 }} />
      </div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-body)", color: labelText }}>Toggle</span>
        <Toggle checked={toggled} onChange={setToggled} />
      </div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-body)", color: labelText }}>Badges</span>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px" }}>
        <span style={{ fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-body)", color: labelText }}>Spinner</span>
        <Spinner size={18} />
      </div>
    </div>
  );
  ...
  return (
    <div style={{ borderRadius: "var(--glass-radius-sm, 10px)", overflow: "hidden", background: tableBg, border: `1px solid ${borderColor}` }}>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr 0.8fr", padding: "10px 14px", background: headerBg, borderBottom: `1px solid ${borderColor}`, gap: "12px" }}>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.06em", fontFamily: "var(--font-ui)", color: headerText }}>Variable</span>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.06em", fontFamily: "var(--font-ui)", color: headerText }}>Current Value</span>
        <span style={{ fontSize: "10px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.06em", fontFamily: "var(--font-ui)", color: headerText }}>Set By</span>
      </div>
      {Object.entries(grouped).map(([category, vars]) => (
        <div key={category}>
          <div style={{ padding: "5px 14px", background: catBg, borderBottom: `1px solid ${rowBorder}` }}>
            <span style={{ fontSize: "9px", fontWeight: 650, textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "var(--font-ui)", color: dimText }}>{category}</span>
          </div>
          {vars.map((v, idx) => {
            ...
            return (
              <div key={v.variable} style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr 0.8fr", padding: "6px 14px", borderBottom: idx < vars.length - 1 ? `1px solid ${rowBorder}` : "none", gap: "12px", alignItems: "center" }}>
                ...
                <span style={{ fontSize: "10px", fontFamily: "var(--font-body)", color: dimText }}>{v.setBy}</span>
              </div>
            );
          })}
        </div>

    ...
    <div style={{ borderRadius: "var(--glass-radius-sm, 10px)", overflow: "hidden", background: tableBg, border: `1px solid ${borderColor}`, height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
          ...
          <span style={{ fontSize: "11px", fontFamily: "var(--font-mono)", fontVariantNumeric: "tabular-nums", color: valueText }}>{Math.round(transparency * 100)}%</span>
        </div>
      ...
      <div style={{ padding: "10px 12px", borderBottom: `1px solid ${rowBorder}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
          ...
          <span style={{ fontSize: "11px", fontFamily: "var(--font-mono)", fontVariantNumeric: "tabular-nums", color: valueText }}>{blurIntensity}px</span>
        </div>
